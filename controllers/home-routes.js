...
// GET route on home page, find all posts
router.get('/', (req, res) => {
...
// GET route to login page. if login button is clicked, redirect to login handlebars page
// if user is on route and logged in, redirect to home page
